...
<body>
	<div class="pane">
		<div class="header"><h1><a href="/PhpProject2">KeepLeView's Discussion Forum</a></h1></div>
		<div class="loginpane">
			<?php
				session_start();
		...
		<?php
			if (isset($_SESSION['username'])) {
				echo "<div class='content'><p><a href='/PhpProject2/newtopic.php?cid=".$_GET['cid']."&scid=".$_GET['scid']."'>
