<?php
	...
	function dispsubcategories($parent_id) {
		...
		while ($row = mysqli_fetch_assoc($select)) {
			echo "<tr><td class='category_title'><a href='/PhpProject2/topics.php?cid=".$row['cat_id']."&scid=".$row['subcat_id']."'>
 ...
 function disptopics($cid,$scid) {
	 ...
	 echo "<tr><th>Title</th><th>Posted By</th><th>Date Posted</th><th>Views</th><th>Replies</th></tr>";
		while($row = mysqli_fetch_assoc($select))
		{	
			echo "<tr><td><a href='/PhpProject2/readtopic.php?cid=".$cid."&scid=".$scid."&tid=".$row['topic_id']."'>
	  ...
	  echo "<p>this category has no topics yet!<a href='/PhpProject2/newtopic.php?cid=".$cid."&scid=".$scid."'>
 ...
 function replylink($cid, $scid, $tid) {
		echo "<p><a href='/PhpProject2/replyto.php?cid=".$cid."&scid=".$scid."&tid=".$tid."'>Reply to this post</a></p>";
	}
 function replytopost($cid, $scid, $tid) {
		echo "<div class='content'><form action='/PhpProject2/addreply.php?cid=".$cid."&scid=".$scid."&tid=".$tid."' method='POST'>
			  <p>Comment: </p>
